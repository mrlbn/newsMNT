	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(username2 == null){
				...
				System.out.println(method);
				if("DELMEMBER".equals(method)||method.equals("DELCO")||method.equals("DELTODAY")||method.equals("DELALLCLOSE")||method.equals("DELALLUSE")){//删除来自后台各个页面的会员
					...
					if(check == null){
						...
						int flag=mmBean.delMember(Integer.getInteger(id));
					...
					int flag=mmBean.delMember(Integer.parseInt(id));
					System.out.println(id);
					if(flag==Constant.SUCCESS){
