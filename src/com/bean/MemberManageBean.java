...
//     今日注册会员
	...
	public int delMember(int id){
		System.out.println("shuju已删除");
		DBO dbo=new DBO();
		dbo.open();
		try{
			dbo.executeUpdate("delete from  member where  id = '"+id+"'");	
			dbo.executeUpdate("delete from  pmember where  mid = '"+id+"'");
			System.out.println("shuju已删除");
			//dbo.executeUpdate("delete from  cmember where  mid = '"+id+"'");
