       ...
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		<%
		  ...
		  <TR align="center" bgColor=#ffffff>
		    <TD id=map><%=i+1 %></TD>
			<TD id=map>
			<a title="点击查看详细信息" href="javascript:void(0);" onclick="checkPmember('<%=basePath %>','<%=dir %>','<%=pagelist2.get(0).toString()%>');">					
			...
			<TD id=map><a href="<%=basePath%>MemberManage?method=delMember&id=<%=pagelist2.get(0).toString()%>">删除</a></TD>
		  </TR>
		<%}%>    	
	     ...
	     <TR>
    	   <TD align="right" vAlign=top >
			 ...
			 <input type="hidden" name="page" value="<%=session.getAttribute("busPage").toString()%>" /><!--//用于给上面javascript传值-->         
				<a href="#" onClick="my_top()"><img src="<%=basePath %>images/first.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
				<a href="#" onClick="my_pre()"><img src="<%=basePath %>images/pre.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
				...
				<a href="#" onClick="my_next()"><img src="<%=basePath %>images/next.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
				<a href="#" onClick="my_last()"><img src="<%=basePath %>images/last.gif" border="0" /></a>
			 第<input name="busjump" type="text" size="3" />页<a href="#" onClick="my_bjump()"><img src="<%=basePath %>images/jump.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
			 </form>
             </TD>
             </TR>
			 </TBODY>
