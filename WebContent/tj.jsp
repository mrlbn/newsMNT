...
<BODY text=#000000 bgColor=#ffffff leftMargin=0 topMargin=0>
	...
	<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%"
		...
		<TBODY>
			<TR>
				<TD class=head colspan="2"><SPAN class=TAG>个性推荐--以下记录根据您最近检索访问自动生成</SPAN>
						...
						<TBODY>
							...
							<tr class="trA" onMouseOver="this.className='trB'"
								...
								<td align="center" bgcolor="#FFFFFF"
									...
									href="<%=basePath%>sinfo.jsp?fenlei=<%=pagelist2.get(1).toString()%>&title=<%=pagelist2.get(2).toString()%>"
